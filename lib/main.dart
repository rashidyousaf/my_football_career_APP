...
import 'package:my_football_career/authentication/signup/club/controller/club_controller.dart';
        ...
        builder: (context, child) {
          return MultiProvider(
            providers: [
              ...
              ChangeNotifierProvider<PlayerAuthController>(
                  create: (_) => PlayerAuthController()),
              ChangeNotifierProvider<CoachController>(
                  create: (_) => CoachController()),
              ChangeNotifierProvider<ClubController>(
                  create: (_) => ClubController()),
              ChangeNotifierProvider<AgencyController>(
                  create: (_) => AgencyController()),
            ...
            child: MaterialApp(
              ...
              routes: {
                ...
                '/ccreateofferscreen1': (context) =>
                    const CcreateOfferScreen1(),
                '/ccreateofferscreen2': (context) =>
                    const CcreateOfferScreen2(),
                '/ccreateofferscreen3': (context) =>
                    const CcreateOfferScreen3(),
                '/ccreateofferscreen4': (context) =>
                    const CcreateOfferScreen4(),
                '/ccreateofferscreen5': (context) =>
                    const CcreateOfferScreen5(),
                '/ccreateofferscreen6': (context) =>
                    const CcreateOfferScreen6(),
                '/ccreateofferscreen7': (context) =>
                    const CcreateOfferScreen7(),
                '/acreateofferscreen1': (context) =>
                    const AcreateOfferScreen1(),
                '/acreateofferscreen2': (context) =>
                    const AcreateOfferScreen2(),
                '/acreateofferscreen3': (context) =>
                    const AcreateOfferScreen3(),
                '/acreateofferscreen4': (context) =>
                    const AcreateOfferScreen4(),
                '/acreateofferscreen5': (context) =>
                    const AcreateOfferScreen5(),
                '/acreateofferscreen6': (context) =>
                    const AcreateOfferScreen6(),
                '/acreateofferscreen7': (context) =>
                    const AcreateOfferScreen7(),
